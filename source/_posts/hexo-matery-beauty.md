---
title: Hexo-matery主题美化以及zeit部署
author: qinng
toc: true
tags:
  - hexo
date: 2020-02-12 00:33:26
categories:
  - tool
---

## 简介
本文主要介绍[Metery主题](https://github.com/blinkfox/hexo-theme-matery)的安装使用，[主题优化](https://github.com/qingwave/hexo-theme-matery)内容包括
- 添加404，诗词样式
- 配置提出，在hexo项目`_data/matery.yml`中配置主题样式，可覆盖`themes/matery/_config`配置
- 调整配色，去掉彩虹配置

## 部署到Zeit.io
Github Page在国内访问较慢，可以将服务部署到静态站[zeit.io](https://zeit.io), 每月20G免费流量，并且能同步github项目。
- Github 账户登陆zeit.io，授予 zeit repo 的 read 权限
...
更推荐使用`git submodule`方式，可获取主题更新
```bash
git submodule add https://github.com/qingwave/hexo-theme-matery.git themes/matery
